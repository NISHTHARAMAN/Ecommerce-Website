                    ...
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex">
                                ...
                                <button onClick={() => toggleWishlist(products)} className={`rounded-full w-10 h-10 bg-${isProductInWishlist(products.id) ? 'red' : 'gray'}-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4`}>
                                    <svg
                                        fill="none"
                                        stroke="currentColor"
                                        strokeLinecap="round"
