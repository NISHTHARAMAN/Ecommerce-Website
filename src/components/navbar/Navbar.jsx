...
import Flag from '../../components/images/indiaflag.png';
  ...
  return (
    <div className="bg-white sticky top-0 z-50">
              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                 ...
                 {user ? <div className="flow-root">
                  ...
                  {user?.user?.email === 'niss12@gmail.com' ? 
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-sky-950 px-4 text-sm font-medium text-white sm:px-6 lg:px-8" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-2xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', }}>SHOPIZER
                    </h1>
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <Link to="/wishlist" className="group -m-2 flex items-center p-2">
                    ...
                    <span className="ml-2 text-sm font-medium text-gray-700 group-hover:text-gray-900">{wishlistItems.length}</span>
                  </Link>
                </div>
